...
<div className="p-3.5 bg-slate-900/80 border border-slate-800 rounded-lg space-y-2.5">
  ...
  <div className="space-y-2 text-xs">
    ...
    <div className="p-2.5 bg-cyan-950/30 border-l-2 border-l-cyan-500 rounded-r text-[11px] text-slate-300">
      ...
      <div>
        长短线定姿，找准“唯一最低点”。Maintain 15° to 30° tilt angle for rapid, uniform zinc drainage, fast run-off, and zero ash trapping on flat surfaces.
      </div>
    </div>
  </div>
          ...
          <div className="bg-slate-950 p-3 rounded-lg border border-slate-800 space-y-2">
            ...
            <div className="w-full h-52 bg-slate-900/90 rounded border border-slate-800/80 flex items-center justify-center p-2">
              <svg viewBox="0 0 320 150" className="w-full h-full">
                <rect x="30" y="12" width="260" height="14" rx="2" fill="#334155" stroke="#64748b" strokeWidth="1.5" />
                <text x="160" y="23" fill="#cbd5e1" fontSize="11" fontWeight="bold" textAnchor="middle" className="font-mono">
                  Beam Rack
                </text>

                <line x1="100" y1="26" x2="100" y2="125" stroke="#64748b" strokeWidth="1.5" strokeDasharray="3 3" />
                <text x="105" y="42" fill="#94a3b8" fontSize="11" fontWeight="bold" className="font-mono">0° Vertical Line</text>

                <line x1="100" y1="26" x2="60" y2="110" stroke="#f43f5e" strokeWidth="2.5" />
                <circle cx="100" cy="26" r="3.5" fill="#f43f5e" />
                <circle cx="60" cy="110" r="3.5" fill="#f43f5e" />

                <line x1="220" y1="26" x2="260" y2="110" stroke="#f43f5e" strokeWidth="2.5" />
                <circle cx="220" cy="26" r="3.5" fill="#f43f5e" />
                <circle cx="260" cy="110" r="3.5" fill="#f43f5e" />

                <path d="M 100 65 A 41 41 0 0 0 81 60" fill="none" stroke="#f59e0b" strokeWidth="2.5" />
                <text x="82" y="78" fill="#f59e0b" fontSize="12" fontWeight="bold" className="font-mono">
                  θ (Rigging Angle)
                </text>

                <rect x="40" y="110" width="240" height="22" rx="3" fill="#1e293b" stroke="#38bdf8" strokeWidth="1.5" />
                <text x="160" y="125" fill="#38bdf8" fontSize="12" fontWeight="bold" textAnchor="middle">
                  Workpiece
                </text>
              </svg>
            </div>
          ...
          <div className="bg-slate-950 p-3 rounded-lg border border-slate-800 space-y-2">
            ...
            <div className="w-full h-72 bg-slate-900/90 rounded border border-slate-800/80 flex items-center justify-center p-2">
              <svg viewBox="0 0 850 420" className="w-full h-full">
                ...
                <rect x="100" y="70" width="200" height="32" rx="16" fill="#022c22" stroke="#10b981" strokeWidth="2" />
                <text x="200" y="91" fill="#34d399" fontSize="14" fontWeight="bold" textAnchor="middle">
                ...
                <rect x="150" y="340" width="550" height="42" rx="8" fill="#0f172a" stroke="#f59e0b" strokeWidth="2" />
    ...
    <div className="fixed inset-0 z-50 bg-slate-950/80 backdrop-blur-sm flex items-center justify-center p-4">
      <div className="bg-slate-900 border border-cyan-500/30 rounded-xl max-w-lg w-full p-4 space-y-4 shadow-2xl">
        ...
        <div className="space-y-3 text-xs text-slate-300 max-h-[65vh] overflow-y-auto pr-1">
          <div className="bg-slate-950 p-3 rounded-lg border border-slate-800 space-y-2">
            <div className="font-bold text-cyan-300 text-[11px]">
              1. 倾角定姿要领：长短线定姿，找准“唯一最低点”
            </div>
            <div className="text-[10px] text-slate-400 leading-relaxed">
              严格贯彻<strong>“长短线定姿，找准‘唯一最低点’”</strong>。 Hanging at <strong className="text-amber-400">15° to 30°</strong> ensures smooth air purging upon entry and rapid molten zinc run-off upon exit, preventing zinc tears, spikes, and ash trapping.
            </div>
            ...
            <div className="w-full h-48 bg-slate-900/90 rounded border border-slate-800 flex items-center justify-center p-2">
              <svg viewBox="0 0 320 140" className="w-full h-full">
                ...
                <text x="270" y="91" fill="#94a3b8" fontSize="11" fontWeight="bold" className="font-mono">0° Horizontal</text>
                ...
                <text x="145" y="80" fill="#f59e0b" fontSize="13" fontWeight="bold" fontFamily="sans-serif">
                  15°–30°
                </text>
                ...
                <text x="260" y="118" fill="#38bdf8" fontSize="11" fontWeight="bold" textAnchor="middle">Rapid Run-off ↓ (Lowest Drain)</text>

                <line x1="20" y1="125" x2="180" y2="125" stroke="#0284c7" strokeWidth="1" strokeDasharray="3 3" opacity="0.5" />
                <text x="25" y="120" fill="#38bdf8" fontSize="10" fontWeight="bold" opacity="0.8">Zinc Kettle Bath Line</text>
              </svg>
            </div>
          </div>
          ...
          <div className="bg-slate-950 p-3 rounded-lg border border-slate-800 space-y-3">
            ...
            <div className="w-full h-36 bg-slate-900/90 rounded border border-slate-800/80 flex items-center justify-center p-2">
              <svg viewBox="0 0 320 110" className="w-full h-full">
                <line x1="20" y1="15" x2="300" y2="15" stroke="#475569" strokeWidth="3" />
                <text x="25" y="11" fill="#94a3b8" fontSize="10" fontWeight="bold" className="font-mono">Beam Rack</text>

                <line x1="80" y1="15" x2="80" y2="40" stroke="#38bdf8" strokeWidth="2" strokeDasharray="3 3" />
                <text x="62" y="32" fill="#38bdf8" fontSize="12" fontWeight="bold" className="font-mono">L₁</text>

                <line x1="240" y1="15" x2="240" y2="90" stroke="#f59e0b" strokeWidth="2" strokeDasharray="3 3" />
                <text x="248" y="58" fill="#f59e0b" fontSize="12" fontWeight="bold" className="font-mono">L₂</text>
                ...
                <g transform="rotate(18 80 40)">
                  ...
                  <text x="160" y="18" fill="#c084fc" fontSize="11" fontWeight="bold" textAnchor="middle" className="font-mono">Distance D</text>
                </g>
