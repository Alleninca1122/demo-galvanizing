          ...
          <div className="bg-slate-950 p-3 rounded-lg border border-slate-800 space-y-2">
            ...
            <div className="w-full h-52 bg-slate-900/90 rounded border border-slate-800/80 flex items-center justify-center p-2">
              <svg viewBox="0 0 800 420" className="w-full h-full">
                ...
                {/* Beam Rack Header */}
                <rect x="100" y="30" width="600" height="24" rx="6" fill="#2563eb" stroke="#3b82f6" strokeWidth="1.5" />
                <text x="400" y="46" fill="#ffffff" fontSize="13" fontWeight="bold" textAnchor="middle" className="font-mono">
                  BEAM RACK FRAME
                </text>

                {/* Outer Tension Lines */}
                <line x1="120" y1="54" x2="80" y2="280" stroke="#f59e0b" strokeWidth="2" strokeDasharray="4 4" />
                <line x1="680" y1="54" x2="720" y2="280" stroke="#f59e0b" strokeWidth="2" strokeDasharray="4 4" />

                {/* Suspension Vertical Wires */}
                <line x1="235" y1="54" x2="235" y2="155" stroke="#94a3b8" strokeWidth="2" />
                <line x1="315" y1="54" x2="315" y2="163" stroke="#94a3b8" strokeWidth="2" />
                <line x1="475" y1="54" x2="475" y2="155" stroke="#94a3b8" strokeWidth="2" />
                <line x1="555" y1="54" x2="555" y2="163" stroke="#94a3b8" strokeWidth="2" />

                {/* Dual-Point Callout */}
                <rect x="205" y="88" width="140" height="26" rx="13" fill="#022c22" stroke="#10b981" strokeWidth="1.5" />
                <text x="275" y="105" fill="#34d399" fontSize="11" fontWeight="bold" textAnchor="middle">
                  Dual-Point Suspension
                </text>

                {/* Workpiece #1 */}
                <g transform="translate(275, 235) rotate(-6)">
                  <rect x="-70" y="-85" width="140" height="170" rx="4" fill="#0f172a" stroke="#38bdf8" strokeWidth="2.5" />
                  <circle cx="-40" cy="-65" r="5" fill="none" stroke="#38bdf8" strokeWidth="2" />
                  <circle cx="40" cy="-65" r="5" fill="none" stroke="#38bdf8" strokeWidth="2" />
                  <text x="0" y="10" fill="#f1f5f9" fontSize="12" fontWeight="bold" textAnchor="middle">
                    Plate Workpiece #1
                  </text>
                </g>
                ...
                {/* Waist Wire */}
                <path d="M 80 280 L 275 268 L 515 272 L 720 280" fill="none" stroke="#f59e0b" strokeWidth="3" strokeDasharray="6 3" />
                <circle cx="80" cy="280" r="6" fill="#f59e0b" />
                <circle cx="720" cy="280" r="6" fill="#f59e0b" />
                <circle cx="275" cy="268" r="5" fill="#10b981" stroke="#ffffff" strokeWidth="1.5" />
                <circle cx="515" cy="272" r="5" fill="#10b981" stroke="#ffffff" strokeWidth="1.5" />

                {/* Waist Wire Label */}
                <line x1="395" y1="270" x2="395" y2="335" stroke="#f59e0b" strokeWidth="1.5" />
                <rect x="280" y="335" width="230" height="34" rx="6" fill="#0f172a" stroke="#f59e0b" strokeWidth="2" />
                <text x="395" y="356" fill="#f59e0b" fontSize="12" fontWeight="bold" textAnchor="middle" className="font-mono">
