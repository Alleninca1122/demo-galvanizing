...
<div className="p-3.5 bg-slate-900/80 border border-slate-800 rounded-lg space-y-2.5">
  ...
  <div className="space-y-2 text-xs">
    ...
    {/* Quality Item 2: Drain & Vent Hole Orientation */}
    <div className="p-2.5 bg-cyan-950/30 border-l-2 border-l-cyan-500 rounded-r text-[11px] text-slate-300">
      <div className="flex items-center justify-between mb-0.5">
        <div className="font-bold text-cyan-300">💎 Quality: Drain & Vent Hole Orientation</div>
        <button
          type="button"
        ...
        >
          <span>🕳️</span>
          <span className="underline decoration-cyan-400/50">Hole Orientation Guide</span>
        </button>
      </div>
      <div>
        Position small air vents at the highest points to allow smooth gas escape, and large drain/run-off holes at the lowest unique points to ensure rapid molten zinc discharge.
      </div>
    </div>

    {/* Quality Item 3: Blind-End Pose Standard */}
    <div className="p-2.5 bg-cyan-950/30 border-l-2 border-l-cyan-500 rounded-r text-[11px] text-slate-300">
      <div className="flex items-center justify-between mb-0.5">
        <div className="font-bold text-cyan-300">💎 Quality: Blind-End Pose Standard (35°–45°)</div>
        <button
          type="button"
        ...
        >
          <span>🪣</span>
          <span className="underline decoration-cyan-400/50">Blind-End Guide</span>
        </button>
      </div>
      <div>
        For sealed or blind-end tubular workpieces, increase tilt angle to 35°–45° with the sealed end pointing upward and the open mouth positioned at the lowest drainage point.
      </div>
    </div>

    {/* Quality Item 4: Drip Corner Clearance */}
    <div className="p-2.5 bg-cyan-950/30 border-l-2 border-l-cyan-500 rounded-r text-[11px] text-slate-300">
      <div className="flex items-center justify-between mb-0.5">
        <div className="font-bold text-cyan-300">💎 Quality: Drip Corner Clearance</div>
        <button
          type="button"
        ...
        >
          <span>📍</span>
          <span className="underline decoration-cyan-400/50">Drip Corner Guide</span>
        </button>
      </div>
      <div>
        Ensure the lowest dripping tip is 100% unobstructed to allow clean, single-point droplet fall-off without secondary pooling or trailing spikes.
      </div>
    </div>

    {/* Quality Item 5: Corner Tie-In & Contour Alignment */}
    <div className="p-2.5 bg-cyan-950/30 border-l-2 border-l-cyan-500 rounded-r text-[11px] text-slate-300">
      <div className="flex items-center justify-between mb-0.5">
        <div className="font-bold text-cyan-300">💎 Quality: Corner Tie-In & Contour Alignment</div>
        <button
          type="button"
        ...
        >
          <span>🔗</span>
          <span className="underline decoration-cyan-400/50">Corner Tie Standard</span>
        </button>
      </div>
      <div>
        Always thread binding wire through corner and edge holes tightly hugging the contour. Strictly prohibit mid-body hole tying which blocks zinc flow.
      </div>
    </div>
  </div>
      ...
      <div className="bg-slate-900 border border-cyan-500/30 rounded-xl max-w-lg w-full p-4 space-y-4 shadow-2xl">
        ...
        <div className="w-full h-44 bg-slate-900/90 rounded border border-slate-800 flex items-center justify-center p-2">
          <svg viewBox="0 0 320 150" className="w-full h-full">
            ...
            <text x="75" y="25" fill="#38bdf8" fontSize="11" fontWeight="bold">Air Vent (Small Hole ↑)</text>
            <text x="160" y="140" fill="#10b981" fontSize="11" fontWeight="bold" textAnchor="middle">Zinc Run-off (Large Hole ↓)</text>
          </svg>
        </div>
        <div className="pt-2 border-t border-slate-800 flex justify-end">
      ...
      <div className="bg-slate-900 border border-cyan-500/30 rounded-xl max-w-lg w-full p-4 space-y-4 shadow-2xl">
        ...
        <div className="w-full h-44 bg-slate-900/90 rounded border border-slate-800 flex items-center justify-center p-2">
          <svg viewBox="0 0 320 150" className="w-full h-full">
            ...
            <text x="65" y="25" fill="#f43f5e" fontSize="11" fontWeight="bold">Sealed Blind End (Top High)</text>
            <text x="160" y="140" fill="#10b981" fontSize="11" fontWeight="bold" textAnchor="middle">Open Mouth (Lowest Point Drainage)</text>
          </svg>
        </div>
        <div className="pt-2 border-t border-slate-800 flex justify-end">
      ...
      <div className="bg-slate-900 border border-cyan-500/30 rounded-xl max-w-lg w-full p-4 space-y-4 shadow-2xl">
        ...
        <div className="w-full h-44 bg-slate-900/90 rounded border border-slate-800 flex items-center justify-center p-2">
          <svg viewBox="0 0 320 160" className="w-full h-full">
            ...
            <text x="160" y="150" fill="#10b981" fontSize="11" fontWeight="bold" textAnchor="middle">100% Free Lowest Tip (Clean Single Drip)</text>
          </svg>
        </div>
        <div className="pt-2 border-t border-slate-800 flex justify-end">
      ...
      <div className="bg-slate-900 border border-cyan-500/30 rounded-xl max-w-lg w-full p-4 space-y-4 shadow-2xl">
        ...
        <div className="w-full h-44 bg-slate-900/90 rounded border border-slate-800 flex items-center justify-center p-2">
          <svg viewBox="0 0 320 150" className="w-full h-full">
            ...
            <text x="30" y="22" fill="#10b981" fontSize="11" fontWeight="bold">✓ Corner/Edge Hole (Tight Contour Wire)</text>
            <text x="160" y="140" fill="#f43f5e" fontSize="11" fontWeight="bold" textAnchor="middle">❌ Mid-Body Hole (Blocks Flow)</text>
          </svg>
        </div>
        <div className="pt-2 border-t border-slate-800 flex justify-end">
